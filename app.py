...
def do_supplement_export(sup_format, sup_bitrate, sup_export_name, sup_wavs, sup_role, ss):
    ...
    try:
        ...
        return file_component_paths.safe_path_for_file_component(final), msg
    except Exception as e:
        return None, str(e)
...
with gr.Blocks(theme=THEME, title=f"Audiobook Studio v{__version__}") as app:
    ...
    e_subtitle_btn.click(export_ui.do_export_subtitles, [ss, e_subtitle], [e_subtitle_out, e_subtitle_msg])

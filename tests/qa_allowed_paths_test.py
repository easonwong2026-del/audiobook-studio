#!/usr/bin/env python3
"""QA 测试：验证 shared File-component safe-path adapter + allowed_paths 白名单。
...
def safe_path_func(isolated_data_dir: str) -> callable:
    """Return the real shared safe-path owner."""
    from ui.file_component_paths import safe_path_for_file_component

    return safe_path_for_file_component
